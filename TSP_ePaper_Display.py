...
EPD_WIDTH = 640
EPD_HEIGHT = 384
TODOIST_TOKEN = '6d2b30289cd3f61172b5b903480a21ba8a24f2bc'
...
def query_todo_list():
    ...
    while True:
        try:
            new_todo_response = requests.get("https://api.todoist.com/API/v8/tasks", params={"token":TODOIST_TOKEN}).json()
            break
        except ValueError:
